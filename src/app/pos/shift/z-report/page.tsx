      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link href="/pos/shift" className="p-2 rounded-lg bg-zinc-800 hover:bg-zinc-700 transition-colors">
        ...
        {report && (
          <>
            ...
            <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-5 space-y-2">
              ...
              <Row label="Ventas Brutas" value={fmt(report.grossSalesCents)} bold />
              ...
              <div className="border-t border-zinc-700 pt-2 mt-2">
                <Row label="Ventas Netas" value={fmt(report.netSalesCents)} bold />
              </div>
              <Row label="Ordenes" value={String(report.ordersCount)} />
            </div>
            ...
            <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-5 space-y-2">
              ...
              <Row label="IGV 18%" value={fmt(report.gravadoIgvCents)} bold />
            ...
            <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-5 space-y-2">
              ...
              <Row label="Apertura" value={fmt(report.cashOpeningCents)} />
              <Row label="Esperado" value={fmt(report.cashExpectedCents)} />
              {report.cashCountedCents !== null && (
                <Row label="Contado" value={fmt(report.cashCountedCents)} />
              )}
