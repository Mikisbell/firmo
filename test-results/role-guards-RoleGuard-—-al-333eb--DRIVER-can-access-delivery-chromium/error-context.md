...
- Name: role-guards.spec.ts >> RoleGuard — allowed access >> DRIVER can access /delivery
- Location: e2e\role-guards.spec.ts:59:3
...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    - heading "🛵 App Motorizado" [level=1] [ref=e4]
    - generic [ref=e5]:
      - paragraph [ref=e6]: "Selecciona tu perfil:"
      - paragraph [ref=e7]: No hay motorizados registrados
