...
- Name: role-guards.spec.ts >> RoleGuard — denied access redirects to / >> CASHIER cannot access /mozo
- Location: e2e\role-guards.spec.ts:79:3
    ...
    - generic [ref=e4]:
      - generic [ref=e5]:
        - generic [ref=e6]:
          - img [ref=e8]
          - generic [ref=e11]:
            - heading "Cajero(a)T-01" [level=1] [ref=e12]
