...
- Name: role-guards.spec.ts >> RoleGuard — allowed access >> KITCHEN can access /cocina
- Location: e2e\role-guards.spec.ts:31:3
...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    - img [ref=e5]
    - heading "Algo salió mal" [level=2] [ref=e7]
    - paragraph [ref=e8]: Ha ocurrido un error inesperado. Por favor, intenta recargar la página.
    - group [ref=e9]:
      - generic "Ver detalles técnicos" [ref=e10] [cursor=pointer]
    - button "Recargar página" [ref=e11]:
      - img [ref=e12]
